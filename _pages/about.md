...
<div style="display: flex; flex-direction: column; align-items: center;">
    <div style="font-size: 16px; line-height: 1.7; max-width: 750px;">
        ...
        <p><span style="font-weight:bold; color:#1e3a8a;">July 2024</span> — Awarded the <span style="color:#d97706; font-weight: 600;">AP-S Undergraduate Summer Research Scholarship</span> and grant, given to only 34 across the world, to research <span style="color:#d97706; font-weight: 600;"> Flexible and ML-Driven Antenna Design on PDMS for sub-6 GHz wearable applications</span>!</p>
