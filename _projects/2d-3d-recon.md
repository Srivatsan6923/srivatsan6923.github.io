...
<p>
    ...
    This project focused on analyzing and evaluating techniques for 3D coronary artery reconstruction from 2D angiograms. It involved a comparative study of both traditional geometric and modern deep-learning approaches, emphasizing their accuracy, computational efficiency, and suitability for vFFR. A selected reconstruction method was also implemented to assess its practical feasibility. The findings underscore the need for accurate and computationally efficient 3D reconstruction solutions to advance clinical practice and improve the precision of CAD diagnosis, treatment planning, and patient outcomes.
</p>
